...
from arti_mani.algorithms.rl_iam.feature_extract import CustomKptGTExtractor
...
if __name__ == "__main__":
    ...
    segmodel_path = (
        VISUALMODEL_DIR
        / "kpt_model/20230307_182821_D64H40W64_deconv3_kpts3norm01addvis_uvz_lr1e-3_mobilenetv2_dropout0.2_newdatafilter2drawer"
    )
    other_handle_visible = False
    num_kpts = 3
    obs_mode = "state_egostereo_keypoints_gt"
    control_mode = "pd_joint_delta_pos"

    # Create log dir
    exp_suffix = "bs128_tr16up16"
    log_dir = f"./logs/sac{train_procs}_tr{len(arti_ids)}eval{len(eval_ids)}{mode}_{obs_mode}{num_kpts}_{exp_suffix}/"
    ...
    model = SAC(
        ...
        policy_kwargs=dict(
            log_std_init=-3.67,
            net_arch=[256, 256],
            features_extractor_class=CustomKptGTExtractor,
            features_extractor_kwargs=dict(num_kpts=num_kpts),
