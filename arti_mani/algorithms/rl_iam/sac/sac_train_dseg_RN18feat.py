...
from arti_mani.algorithms.rl_iam.feature_extract import CustomRGBDPredSegResNetExtractor
...
if __name__ == "__main__":
    ...
    # Create log dir
    exp_suffix = "100steps_padfriction1_p3000d100_bs128tr16up16"
    ...
    model = SAC(
        ...
        policy_kwargs=dict(
            log_std_init=-3.67,
            net_arch=[256, 256],
            features_extractor_class=CustomRGBDPredSegResNetExtractor,
            features_extractor_kwargs=dict(
                state_repeat_times=state_repeat_times,
                vismodel_path=segmodel_path,
                device=device,
            ),
