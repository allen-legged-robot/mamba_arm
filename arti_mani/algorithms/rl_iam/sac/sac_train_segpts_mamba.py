...
from arti_mani.algorithms.rl_iam.feature_extract import CustomSegMambaExtractor
...
if __name__ == "__main__":
    ...
    log_dir = f"./logs/sac{train_procs}_mamba_tr{len(arti_ids)}eval{len(eval_ids)}{mode}_{obs_mode}_{sample_mode}f{frame_num}s{pts_sample_num}_{exp_suffix}/"
    ...
    model = SAC(
        ...
        policy_kwargs=dict(
            log_std_init=-3.67,
            net_arch=[256, 256],
            features_extractor_class=CustomSegMambaExtractor,
